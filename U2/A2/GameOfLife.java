...
public class GameOfLife {
    ...
    public static void main(String[] args) throws ClassNotFoundException,
        ...
        int generation = 0;
        int remaining = 400;
        int start = Integer.parseInt(JOptionPane
        ...
        for (int row = 0; row < grid.length; row++) {
            for (int colom = 0; colom < grid[row].length; colom++) {
                ...
                int rand = new Random().nextInt((start / 100) > 2 ? start / 100
                        : 2);
        ...
        try {
            ...
            while (true) {
                ...
                for (int row = 0; row < grid.length; row++) {
                    for (int colom = 0; colom < grid[row].length; colom++) {
                        System.out.print(grid[row][colom]);
                    }
                    System.out.println();
                }
                // up the generation
                ...
                for (int row = 0; row < grid.length; row++) {
                    for (int colom = 0; colom < grid[row].length; colom++) {
                        if (grid[row][colom] == 1) {// alive
                            ...
                            int x = left + right + top + bottom;// add all 4 sides
