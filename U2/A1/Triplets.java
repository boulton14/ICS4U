...
public class Triplets {
    public static void main(final String[] args) {
        ...
        final ArrayList<String> nouns = new ArrayList<String>();
        nouns.add("cat");
        nouns.add("dog");
        nouns.add("horse");
        nouns.add("goat");
        ...
        final ArrayList<String> verbs = new ArrayList<String>();
        verbs.add("ate");
        verbs.add("slept");
        verbs.add("jumped");
        verbs.add("raced");
        ...
        final ArrayList<String> rhymingNouns = new ArrayList<String>();
