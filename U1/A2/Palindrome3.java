 ...
 * @purpose Checks if phrase is a planedrom
...
public class Palindrome3 {
    ...
    public static void main(final String[] args) throws ClassNotFoundException,
        ...
        final String word = JOptionPane.showInputDialog("Enter a word: ")
                .replace(" ", "");
        final String reverse = Palindrome3.reverse(word);// fetch the reverse
        // output the results
        System.out
    ...
    public static String reverse(final String s) {
        ...
        return Palindrome3.reverse(s.substring(1, s.length())) + s.charAt(0);
    }
}
