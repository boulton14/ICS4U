...
public class PhoneTester {
    public static void main(final String[] args) {
        ...
        final CellPhone phone = new CellPhone("Rogers", "iPhone", 1.2, 64.0, 10);
        ...
        while (true) {
            ...
            try {
                ...
                System.out
                        .println("There was an error entering the information please try again");
                continue;
            }
            // create the custom phone for the user
            final CellPhone custom = new CellPhone(carrier, type, speed,
                    memory, apps);
            ...
            System.out
                    .println("Speed of phone = " + custom.getSpeed() + " Ghz");
